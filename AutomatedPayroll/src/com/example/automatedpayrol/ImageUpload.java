...
public class ImageUpload extends Activity {
	...
	Button btpic, btnup;
    String ba1;
    public static String URL = "http://kareeshoma.netai.net/MainProject/image.php";
    ...
    public class uploadToServer extends AsyncTask<Void, Void, String> {
        ...
        private ProgressDialog pd = new ProgressDialog(ImageUpload.this);
        ...
        protected void onPostExecute(String result) {
            ...
            pd.hide();
            pd.dismiss();
            Intent intent = new Intent(ImageUpload.this,LocationDB.class);
